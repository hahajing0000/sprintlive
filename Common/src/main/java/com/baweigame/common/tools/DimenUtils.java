 ...
 * @CreateDate: 2021/9/30 8:33
 * @UpdateUser: 张跃
 * @UpdateDate: 2021/9/30 8:33
 * @UpdateRemark:
 * @Version: 1.0
 */
public class DimenUtils {
    ...
    public static float dpToPx(float dp) {
        return dp * BaseApplication.getAppContext().getResources().getDisplayMetrics().density;
    }
    ...
    public static float pxToDp(float px) {
        return px / BaseApplication.getAppContext().getResources().getDisplayMetrics().density;
    }
    ...
    public static float pxToSp(float pxValue) {
        return pxValue / BaseApplication.getAppContext().getResources().getDisplayMetrics().scaledDensity;
    }
    ...
    public static float spToPx(float spValue) {
        return spValue * BaseApplication.getAppContext().getResources().getDisplayMetrics().scaledDensity;
    }
}
